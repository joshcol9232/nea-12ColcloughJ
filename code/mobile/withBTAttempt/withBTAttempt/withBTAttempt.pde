...
//private final BroadcastReceiver mBroadcastReciever1 = new BroadcastReciever(){
//  void onRecieve(Context context, Intent intent){
//    final String action = intent.getAction();
    
//    if (action.equals(BlueoothDevice.ACTION_BOND_STATE_CHANGED)){
//      BluetoothDevice mDevice = intent.getParcelableExtra(BluetoothDevice.EXTRA_DEVICE);
//      if (mDevice.getBondState() == BluetoothDevice.BOND_BONDED){
//        println("Bonded to device.");
//      }
...
boolean checkBT() {
  pairedDevices = mBluetoothAdapter.getBondedDevices();  //Gets paired devices
