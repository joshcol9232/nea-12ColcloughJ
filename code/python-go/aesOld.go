...
func main() {
	out := encryptFileName([]byte{0x00, 0x0b, 0x16, 0x1d, 0x2c, 0x27, 0x3a, 0x31, 0x58, 0x53, 0x4e, 0x45, 0x74, 0x7f, 0x62, 0x69}, "my name is jeff lol what this should be longer than 16 in length")
  fmt.Println(out)
