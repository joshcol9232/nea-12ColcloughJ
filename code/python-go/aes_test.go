...
func BenchmarkEncryptFile(b *testing.B) {
  ...
  w := "/home/josh/temp"
  expandedKeys := expandKey([]byte{0x00, 0x0b, 0x16, 0x1d, 0x2c, 0x27, 0x3a, 0x31, 0x58, 0x53, 0x4e, 0x45, 0x74, 0x7f, 0x62, 0x69})
  for n := 0; n < b.N; n++ {
    encryptFile(expandedKeys, f, w)
  }
}
