...
def encryptFileMulCores(key, f, w):
    ...
    bufferSize = 16384*multiprocessing.cpu_count() #16 Kb per core. Any more than this gives diminishing returns. Also, with hyperthreading enabled this doesn't increase speed much.
    if fileSize < bufferSize:
        bufferSize = fileSize
...
def decryptFileMulCores(key, f, w):
    ...
    bufferSize = 16384*multiprocessing.cpu_count()#65536 #Any more than this gives diminishing returns
    customBuff = False
    if fileSize < bufferSize:
        bufferSize = fileSize
