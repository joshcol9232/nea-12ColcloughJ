...
![](Design/Thumbnail/TestResults/ImageQuality/8k/test1.png)
...
![](Design/Thumbnail/TestResults/ImageQuality/8k/test1Close.png)
...
![](Design/Thumbnail/TestResults/ImageQuality/8k/test2.png)

This image looks quite grainy, and doesn't look nearly as smooth as method 1, however if you were too look at this image small, it would look alright (here it is at 25% size):

<img src="Design/Thumbnail/TestResults/ImageQuality/8k/test2.png" style="zoom:25%"/>

Here is a close up comparison between the original and the image generated by <b>Method 2</b>:

![](Design/Thumbnail/TestResults/ImageQuality/8k/test2Close.png)

This method is still relatively good because you can still see the important features such as the light levels and the shape of the rock, however it is a bit spotty where the selected pixel chosen has differed from the surrounding pixels. A lot of the detail is lost in the side of the cliff to the right as well, compared to the last method.

Here is a comparison between <b>Method 1</b> and <b>Method 2</b>:

![](Design/Thumbnail/TestResults/ImageQuality/8k/methodComparison1.png)

<b>Method 1</b> 									     <b>Method 2</b>

In method 1, the shape of the cliff looks a lot more like the original than method 2, and the colours of the cliff face transition well into the colours of the ocean. Method 1 makes much better thumbnails, as it produces blurry images, which is better than the grainy images produced by method 2.

<u><b>Medium-Small images:</b></u>

These tests will be done on the apple image.

##### Method 1:

Here is what method 1 produced from the apple image using a scan length of 5 (original size = 300x315, new size = 60x63):

<img src="Design/Thumbnail/TestResults/ImageQuality/Apple/test1.png" style="zoom:50%"/>

The colours resemble the original very well, and the colour of the apple blends in nicely with the backround.

##### Method 2:

<img src="Design/Thumbnail/TestResults/ImageQuality/Apple/test2.png" style="zoom:50%"/>
